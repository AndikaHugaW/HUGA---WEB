            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="group w-10 h-10 rounded-full border-2 border-gray-700 hover:border-[#00ff88] flex items-center justify-center text-gray-400 hover:text-[#00ff88] transition-all duration-300"
